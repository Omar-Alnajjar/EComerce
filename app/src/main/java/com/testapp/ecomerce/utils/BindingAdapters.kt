package com.testapp.ecomerce.utils
...
object BindingAdapters {
    ...
    fun ImageView.loadImage(imageLink: String?) {
        Glide.with(this.context).load(imageLink).placeholder(R.drawable.ic_image_place_holder)
            .error(R.drawable.ic_image_place_holder).into(this)
